...
Modify the following code to plot a <p style="color:red;">red</p> `cat`:
...
```{r print-species, exercise = TRUE, exercise.eval = TRUE, exercise.lines=3:4}
ran <- image_list(start = sample(1:image_count(), 1), length = 1)[[1]]$uid
random <- image_data(ran, size = "512")[[1]]
ggplot() +
  phylopic(nightshade, col = "grey")
```
